...
ActiveRecord::Schema.define(:version => 20160728025621) do
  ...
  add_index "orbit_diagrams", ["asteroid_designation"], :name => "index_orbit_diagrams_on_asteroid_id"
